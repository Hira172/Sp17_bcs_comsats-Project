...
# used
 # it is backbone for yolo model
# partition the feature map of the base layer into two parts and merge them through cross hierarchy
...
def Create_Yolo(input_size=YOLO_INPUT_SIZE, channels=3, CLASSES=YOLO_COCO_CLASSES):
    NUM_CLASS = len(read_class_names(CLASSES))
    input_layer = Input([input_size, input_size, channels]) # create tensorflow keras input layer shape
