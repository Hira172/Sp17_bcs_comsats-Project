...
def Load_Yolo_model():
    ...
    # Create_Yolo model is in yoloModels
...
# used
# calculating parameters required for image processing method
def parameters_for_img_processing(image, target_size):
    ih, iw = target_size
    h, w, _ = image.shape
    scale = min(iw / w, ih / h)
    ...
    return nw,nh,ih,iw,dh,dw


# used
# need to understand
def image_preprocess(image, target_size,nw,nh,ih,iw,dh,dw):
