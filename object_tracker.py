...
def Object_tracking(Yolo, video_path, output_path, input_size=416, show=False, CLASSES=YOLO_COCO_CLASSES, score_threshold=0.3, iou_threshold=0.45, rectangle_colors='', Track_only = []):
    ...
    while True:
        ...
        tracked_bboxes = time_to_contact(original_frame, tracker.matchedBoxes, newTime, prevTime, key_list, val_list)
...
Object_tracking(yolo, video_path, "detection.avi", input_size=YOLO_INPUT_SIZE, show=True, iou_threshold=0.1, rectangle_colors=(255,0,0),Track_only = ['car','truck','motorbike','person'])
